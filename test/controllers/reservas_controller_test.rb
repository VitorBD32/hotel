...
class ReservasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reserva" do
    assert_difference("Reserva.count") do
      post reservas_url, params: { reserva: { check_in: @reserva.check_in, check_out: @reserva.check_out, hospede_id: @reserva.hospede_id, quarto_id: @reserva.quarto_id } }
    end
  ...
  test "should update reserva" do
    patch reserva_url(@reserva), params: { reserva: { check_in: @reserva.check_in, check_out: @reserva.check_out, hospede_id: @reserva.hospede_id, quarto_id: @reserva.quarto_id } }
